      ...
      <div class="kpi-row-5 mb-6" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 0.875rem;">
        ...
        <div class="bg-white rounded-xl p-4 border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between min-h-[114px]">
          ...
          <p class="text-[11px] text-slate-500 truncate" id="kpi-classes-sub" title="<?php echo "{$classesMetric['total_sections']} Sections • {$classesMetric['total_students']} Students"; ?>">
            <?php echo "{$classesMetric['total_sections']} Sec • {$classesMetric['total_students']} Students"; ?>
          </p>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col justify-between min-h-[114px]">
          <div class="flex items-center justify-between gap-1">
            <span class="text-[11px] font-bold text-slate-400 uppercase tracking-wider truncate">Attendance Rate</span>
          ...
          <div class="my-1">
            <div class="text-xl sm:text-2xl font-black text-emerald-600 flex items-baseline gap-1.5" id="kpi-attendance-rate">
              <?php echo $attendanceMetric['rate_percentage'] > 0 ? "{$attendanceMetric['rate_percentage']}%" : '0.0%'; ?>
              <?php if (!empty($attendanceMetric['is_all_time'])): ?>
                <span class="text-[9px] font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded leading-none">Term Avg</span>
              <?php endif; ?>
            </div>
          </div>
        ...
        <!-- Metric 5: At-Risk Alerts -->
        <a href="<?php echo url('teacher/tardy-logs'); ?>" class="bg-white rounded-xl p-4 border border-slate-100 shadow-sm hover:shadow-md hover:border-rose-300 transition group flex flex-col justify-between min-h-[114px]">
          <div class="flex items-center justify-between gap-1">
            <span class="text-[11px] font-bold text-slate-400 group-hover:text-rose-600 transition uppercase tracking-wider truncate">At-Risk Alerts</span>
          ...
          <p class="text-[11px] text-slate-500 group-hover:text-rose-600 font-medium truncate transition">≥ 3 absences</p>
        </a>
      </div>
