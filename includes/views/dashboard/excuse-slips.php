...
<body class="min-h-screen">
              ...
              <form id="excuse-submit-form" onsubmit="handleExcuseSubmit(event)">
                ...
                <div class="mb-6">
                  ...
                  <div id="file-preview" class="hidden mt-2 p-3 rounded-lg flex items-center gap-3" style="background:var(--color-teal-100)">
                    ...
                    <button type="button" class="ml-auto text-sm font-semibold" style="color:var(--color-absent)" onclick="removeFile()">✕ Remove</button>
                  </div>
                </div>
  ...
  <div id="slide-panel">
    ...
    <!-- Attachment -->
    <div class="mb-4">
      <button type="button" class="btn btn-secondary btn-sm w-full">📄 View Attachment</button>
    </div>
    ...
    <div class="flex gap-3">
      <button type="button" class="btn btn-danger flex-1 justify-center" onclick="closeReviewPanel(); APP.showToast('Excuse slip rejected.', 'info')">✗ Reject</button>
      <button type="button" class="btn btn-primary flex-1 justify-center" onclick="closeReviewPanel(); APP.showToast('Excuse slip approved!', 'success')">✓ Approve</button>
    </div>
  </div>
