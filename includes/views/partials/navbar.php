  ...
  <div class="flex items-center gap-2.5">
    ...
    <div class="relative">
      ...
      <div id="user-dropdown" class="hidden absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-slate-200 z-50 py-1.5 overflow-hidden">
        ...
        <a href="<?php echo url('personal-settings'); ?>" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium text-slate-700 hover:bg-slate-50 transition">
        ...
        <?php if ($isAdmin): ?>
        <a href="<?php echo url('settings'); ?>" class="flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium text-slate-700 hover:bg-slate-50 transition border-t border-slate-50">
