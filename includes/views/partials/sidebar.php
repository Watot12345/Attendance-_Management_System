...
<aside id="sidebar" class="flex flex-col h-screen sticky top-0 shrink-0 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border-r border-slate-800/80 text-slate-200 z-40 shadow-2xl">
  ...
  <nav class="flex-1 py-3.5 px-3 space-y-1 overflow-y-auto no-scrollbar">
    ...
    <?php else: ?>
      ...
      <!-- Courses & Sections -->
      <a href="<?php echo url('admin/courses-sections'); ?>" class="nav-item flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-semibold transition group <?php echo isActiveLink('admin/courses-sections', $pathOnly) ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30 font-bold' : 'text-slate-300 hover:text-white hover:bg-slate-800/80'; ?>">
        <svg class="w-4 h-4 shrink-0 <?php echo isActiveLink('admin/courses-sections', $pathOnly) ? 'text-white' : 'text-slate-400 group-hover:text-blue-400'; ?> transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
