...
if (!function_exists('isActiveLink')) {
    function isActiveLink(string|array $targets, string $current): bool {
        $cleanCurrent = strtolower(trim($current, '/'));
        if ($cleanCurrent === '' || $cleanCurrent === 'index.php') {
            $cleanCurrent = 'dashboard';
        }

        $targetList = is_array($targets) ? $targets : [$targets];
        foreach ($targetList as $target) {
            $cleanTarget = strtolower(trim($target, '/'));
